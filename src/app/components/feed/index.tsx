      ...
      {posts.length > 0 ? (
        <section className={style.f}>
          ...
          <div className={style.content}>
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Magni aut unde dolorem reprehenderit iusto cumque
              sit minus sapiente dolores quisquam, maiores hic eos distinctio aliquam earum mollitia alias libero
              veniam.
            </p>
          </div>
